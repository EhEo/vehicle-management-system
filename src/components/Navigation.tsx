...
const Navigation = () => {
  ...
  const menuItems = [
    ...
    { href: '/vehicles', label: '차량 관리', icon: VanIcon },
        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className="md:hidden">
            <select
              ...
              className="border border-gray-300 rounded-md px-3 py-2 text-sm bg-white text-gray-900 font-medium focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            >
              {menuItems.map((item) => (
